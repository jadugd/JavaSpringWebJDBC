...
<head>
	...
	<title>.:MARCOMM 174:.<decorator:title/></title>
	<!-- Bootstrap 3.3.6 -->
	...
	<link rel="stylesheet" href="${contextName}/assets/dist/css/custom.css">
	...
	<meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
	  ...
	  <link rel="stylesheet" href="${contextName}/assets/dist/css/AdminLTE.min.css">
	  <!-- SweetAlert -->
	  <link rel="stylesheet" href="${contextName}/assets/plugins/sweetAlert/sweetalert2.min.css">
  	  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="${contextName}/assets/dist/css/skins/_all-skins.min.css">
	<decorator:head/>
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<!-- input-masks -->
	<script src="${contextName}/assets/plugins/input-mask/jquery.inputmask.js"></script>
	<!-- jquery validation -->
	<script src="${contextName}/assets/plugins/jQueryValidation/jquery.validate.min.js"></script>
	<!-- SweetAlert -->
	<script src="${contextName}/assets/plugins/sweetAlert/sweetalert2.all.min.js"></script>
	<!-- AdminLTE App -->
	<script src="${contextName}/assets/dist/js/app.min.js"></script>
