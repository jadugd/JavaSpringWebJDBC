    ...
    <section class="content-header">
      ...
      <div class="box box-primary box-solid">
        <div class="box-header with-border">
          <h3 class="box-title">List Souvenir Request (Approval)</h3>
        </div>
        <!-- box header -->
        <!-- panel breadcrumb -->
...
<script>
  ...
  function listDataSouvenir() {
    $.ajax({
      url:"souvenirreq_approval/list.html",
      type:"get",
      dataType:"html",
  ...
  $(document).ready(function(){
    ...
    $("#modal-input").on("submit","#form-souvenir-request-approve", function(){
      ...
      $.ajax({
        url:"souvenirreq_approval/approve/save.json",
        type:"get",
        dataType:"json",
        data:$(this).serialize(),
        success: function(result){
          ...
          swal({
			  title: 'Data Saved!',
			  text: 'Transaction Souvenir Request has been Approved',
			  type: 'success',
    ...
    $("#list-data-souvenir-request").on("click", "#button-approval", function(){
      ...
      $.ajax({
        url:"souvenirreq_approval/approval.html",
        type:"get",
        dataType:"html",
        data: {id:idDetail},
        success: function(result){
